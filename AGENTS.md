...
- Mobile layouts include a `.hdr-sub` bar under the header with a location selector and search icon. Its padding is now `5px 12px`, tightening the spacing beneath the header on small screens.
