...
- Orders:
  ...
  - Order cards display the bar's name via `order.bar_name`.
    ...
    - Order list cards match bar card width (405px desktop, 305px mobile) and add 10px internal padding (was 5px) while allowing their height to expand with content.
